 ...
 * The only class should use this is {@link AppProvider}.
 */
...
//        sSQL = "CREATE TABLE Tasks (_id INTEGER PRIMARY KEY NOT NULL, Name TEXT NOT NULL, Description TEXT, SortOrder INTEGER, CategoryID INTEGER);";
        ...
        sSQL = "INSERT INTO " + TaskContract.TABLE_NAME + " (" +  TaskContract.Columns._ID +
                ", " + TaskContract.Columns.TASK_NAME + ", " + TaskContract.Columns.TASK_DESCRIPTION +
                ") VALUES (1, 'Walk', 'to go for a walk');";
        Log.d(TAG, sSQL);
        db.execSQL(sSQL);
        sSQL = "INSERT INTO " + TaskContract.TABLE_NAME + " (" +  TaskContract.Columns._ID +
                ", " + TaskContract.Columns.TASK_NAME + ", " + TaskContract.Columns.TASK_DESCRIPTION +
                ") VALUES (2, 'Smile', 'smile to everybody');";
        Log.d(TAG, sSQL);
        db.execSQL(sSQL);
        sSQL = "INSERT INTO " + TaskContract.TABLE_NAME + " (" +  TaskContract.Columns._ID +
                ", " + TaskContract.Columns.TASK_NAME + ", " + TaskContract.Columns.TASK_DESCRIPTION +
                ") VALUES (3, 'Cook', 'cook something tasty');";
        Log.d(TAG, sSQL);
        db.execSQL(sSQL);
        sSQL = "INSERT INTO " + TaskContract.TABLE_NAME + " (" +  TaskContract.Columns._ID +
                ", " + TaskContract.Columns.TASK_NAME + ", " + TaskContract.Columns.TASK_DESCRIPTION +
                ") VALUES (4, 'Read', 'to read a book');";
        Log.d(TAG, sSQL);
        db.execSQL(sSQL);
